/**
 * Support API Service - Admin Back-Office
 */
...
export const updateTicketStatus = async (
  ...
  const response = await apiClient.put(`/support/admin/tickets/${ticketId}/status`, { status });
  return response.data;
};
...
export const updateTicketPriority = async (
  ...
  const response = await apiClient.put(`/support/admin/tickets/${ticketId}/priority`, { priority });
  return response.data;
};
...
export const addReply = async (
  ...
  const response = await apiClient.post(`/support/tickets/${ticketId}/replies`, {
    message,
    isInternalNote
  });
  return response.data;
...
export const getStatistics = async (): Promise<{ success: boolean; statistics: AdminStats }> => {
  const response = await apiClient.get('/support/admin/statistics');
  return response.data;
};
...
export const getAvailableAdmins = async (): Promise<{ success: boolean; admins: Admin[] }> => {
  const response = await apiClient.get('/support/admin/admins');
  return response.data;
};
